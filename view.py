...
class Screen:  # Classe qui gère la vue de l'écran #
    ...
    def runmenu(
        self, parameters, gamescreen, controller
    ):  # Affichage de l'écran de menu principal #

        menuwindow = Tk()
        menuwindow.title(self.titlename)
        menuwindow.iconbitmap(bitmap=self.icon)
        ...
        easy_button = Button(
            menuwindow,
            image=easy_button_logo,
            command=lambda: [
                parameters.difficultyset(1),
        ...
        hard_button = Button(
            menuwindow,
            image=hard_button_logo,
            command=lambda: [
                parameters.difficultyset(2),
                parameters.numbertofind(),
                menuwindow.destroy(),
                self.rungame(parameters, gamescreen, controller),
            ],
    ...
    def rungame(
        ...
        indication_text = Label(
            gamewindow,
            textvariable=indication_text_var,
            bg=self.bgcolor,
            fg=self.fg,
            font=self.font,
        )
        ...
        checkbutton = Button(
            gamewindow,
            image=checkbutton_img,
            command=lambda: [
                controller.justprice(
                    indication_text_var,
                    number_entry,
                    parameters.number_to_find,
                    parameters,
                    checkbutton,
                    gamewindow,
                    gamescreen,
